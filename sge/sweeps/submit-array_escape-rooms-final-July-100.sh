...
exp_name_values=( escape-rooms-final-July-100 )
track_values=( True )
cuda_values=( True )
...
data_dir_values=( /data/scratch/acw434/escape-rooms-final-July-100 )
checkpoint_path_values=( /data/scratch/acw434/escape-rooms-final-July-100/checkpoints )
checkpoint_interval_values=( 200 )
trial=${SGE_TASK_ID}
