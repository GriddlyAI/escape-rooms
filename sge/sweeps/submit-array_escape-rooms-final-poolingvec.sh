...
#$ -pe smp 8
#$ -l h_vmem=11G
#$ -N escape-rooms-final-poolingvec
#$ -l gpu=1
#$ -l gpu_type=ampere
#$ -l h_rt=10:0:0
#$ -t 1-10
...
exp_name_values=( escape-rooms-final-poolingvec )
track_values=( True )
cuda_values=( True )
...
data_dir_values=( /data/scratch/acw434/escape-rooms-final-poolingvec )
checkpoint_path_values=( /data/scratch/acw434/escape-rooms-final-poolingvec/checkpoints )
checkpoint_interval_values=( 75 )
trial=${SGE_TASK_ID}
